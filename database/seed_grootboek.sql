-- =============================================================
-- Natuurwaarnemer ERP — Seed: Grootboekrekeningen (RGS 0xxx-9xxx)
-- =============================================================
-- Volledig Nederlands Referentie Grootboekschema per reeks (0xxx t/m 9xxx)
-- BTW-codes: H = hoog (21%), L = laag (9%), V = vrijgesteld, G = geen/n.v.t.
...
INSERT OR IGNORE INTO ledger_accounts (code, name, type, btw_code) VALUES
    ...
    -- 1xxx — Vlottende activa / bank / kas
    ('1000', 'Kas',                               'activa',         'G'),
    ...
    ('4400', 'Inkoopkosten',                      'passiva',        'H'),
    ('4410', 'Kantoorkosten',                     'passiva',        'H'),
    ('4420', 'Reiskosten',                        'passiva',        'H'),
    ('4430', 'Marketing en reclame',              'passiva',        'H'),
    ('4440', 'Automatiseringskosten',             'passiva',        'H'),
    ('4450', 'Verzekeringen',                     'passiva',        'V'),
    ('4460', 'Telefoon en internet',              'passiva',        'H'),
    ('4470', 'Huur en leasing',                   'passiva',        'V'),
    ('4480', 'Energie en nutsvoorzieningen',      'passiva',        'V'),
    ('4490', 'Overige inkoopkosten',              'passiva',        'H'),
    ...
    ('5500', 'Inhuur derden / ZZP',               'kosten',         'H'),
    ...
    -- 6xxx — Financiële kosten / afschrijvingen
